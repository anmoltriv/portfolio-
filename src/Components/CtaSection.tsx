  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 relative z-10">
      <TiltCard className="rounded-2xl" maxTilt={4}>
        <div className="bg-[#0c0c0c] border border-white/10 rounded-2xl p-8 md:p-12 relative overflow-hidden group/ctacard flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
