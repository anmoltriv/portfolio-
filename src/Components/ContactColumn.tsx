...
export default function ContactColumn() {
  ...
  return (
    <div className="md:col-span-1 flex flex-col gap-6">
      <TiltCard className={`bg-white/[0.02] border border-white/10 rounded-2xl p-5 flex items-center gap-3.5 overflow-hidden ${tokens.cardHoverTinted}`}>
      ...
      <TiltCard className={`bg-white/[0.02] border border-white/10 rounded-2xl p-5 flex-1 flex flex-col justify-between overflow-hidden ${tokens.cardHover}`}>
        <div className="relative z-10">
          ...
          <p className="text-xs font-mono text-white/80">{SITE.phone}</p>
        </div>
            ...
            >
              {copied ? (
                ...
                <>
                  ...
                  <span className="font-mono">Tap to copy email</span>
                </>
              )}
            </button>
          </Magnetic>
